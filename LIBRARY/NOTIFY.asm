...
IF HI(NOTIFY_START)=&DD;MASTER
	SAVE "M\$.NOTIFY", NOTIFY_START, NOTIFY_END
ELIF HI(NOTIFY_START)=&0E
	SAVE "E\$.NOTIFY", NOTIFY_START, NOTIFY_END
ELSE
	SAVE "O\$.NOTIFY", NOTIFY_START, NOTIFY_END
ENDIF
