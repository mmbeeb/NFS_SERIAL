...
.Label_9723
	...
	JMP Sub_0D14_Next		; RTI - Ignore frame?? no just next nmi call (counter is saved in ?&A2 !!!)
...
.Label_98C3
	...
	BPL Sub_98EE			; If RDA = 0 no data

	LDA &A2
	ORA &A3
	ORA ptrA4L
	ORA ptrA4H
	BEQ Sub_988E			; If !&A2 = 0, all done
...
{
	LDA RXTX_Flags_D4A
	BPL Label_98F9			; Send reply

	JSR Sub_994E
	JMP Sub_9EA8_tx_success ; CB?0 = 0
...
.Label_98F9
	...
	LDA #LO(Sub_9995)		; Update receive control block
	LDY #HI(Sub_9995)
}
