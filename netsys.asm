...
.nfs_call_table1
	...
	EQUB LO(NFS_CALL_0E-1)		; OS PROCEDURE Insert Key
	EQUB LO(NFS_CALL_0F-1)		; OS PROCEDURE Remote
	EQUB LO(NFS_CALL_10-1)		; OS PROCEDURE Update workspace
	EQUB LO(NFS_CALL_11-1)		; OS PROCEDURE Fatal error
	EQUB LO(NFS_CALL_12-1)		; OS PROCEDURE ?
...
IF _ADLC_
	LDA #&2A
ELSE
	LDA #&20			;Take account of calling sp_poll.
ENDIF
	PHA				; S0
...
.Label_8559
	...
	PLA				; S0
	BEQ Error_NoReply_Sub_850C	;Timed out!
...
ENDIF
	...
	BMI Label_861D			; Wait for result
