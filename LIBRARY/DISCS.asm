...
IF HI(DISCS_START)=&DD;MASTER
	SAVE "M\$.DISCS", DISCS_START, DISCS_END
ELIF HI(DISCS_START)=&0E
	SAVE "E\$.DISCS", DISCS_START, DISCS_END
ELSE
	SAVE "O\$.DISCS", DISCS_START, DISCS_END
ENDIF
