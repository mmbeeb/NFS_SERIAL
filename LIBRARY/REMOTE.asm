...
IF HI(REMOTE_START)=&DD;MASTER
	SAVE "M\$.REMOTE", REMOTE_START, REMOTE_END
ELIF HI(REMOTE_START)=&0E
	SAVE "E\$.REMOTE", REMOTE_START, REMOTE_END
ELSE
	SAVE "O\$.REMOTE", REMOTE_START, REMOTE_END
ENDIF
